...
public class BlueFin extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .strafeToLinearHeading(new Vector2d(-14.509, -58.671), Math.toRadians(291.5))
                .waitSeconds(4.3)
                .afterTime(.5, Intake)
                .strafeToLinearHeading(new Vector2d(-62.824, -63), Math.toRadians(180))
                .strafeToLinearHeading(new Vector2d(-52, -63), Math.toRadians(180))
                //.afterTime(1.6,Intake)
                .strafeToLinearHeading(new Vector2d(-62.824, -64.167), Math.toRadians(170))
                .waitSeconds(1)
