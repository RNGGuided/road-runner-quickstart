...
public class DayOfAuton extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d initialPose = new Pose2d(51.605, 50.459, Math.toRadians(44));
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .afterTime(1,S2)
                .strafeToLinearHeading(new Vector2d(10,17 ),Math.toRadians(45))
                .waitSeconds(4.5)
                .strafeToLinearHeading(new Vector2d(26.942,-10),Math.toRadians(0))
                .afterTime(0,Intake2)
